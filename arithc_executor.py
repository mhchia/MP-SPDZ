...
CIRCUIT_NAME = 'arith_example'
CIRCUIT_INTERPRETER_PATH = Path(f'Programs/Source/{CIRCUIT_NAME}.mpc')
CIRCUIT_INTERPRETER_PATH.mkdir(parents=True, exist_ok=True)
...
ARITH_CIRCUIT_NAME = 'arith_example'
ARITH_CIRCUIT_PATH = f"Programs/Circuits/arith_example.txt"
...
def main():
    ...
    interpreter_code = generate_arith_circuit_interpreter(input_from_which_party, constants, num_outputs)
...
def generate_arith_circuit_interpreter(input_from_which_party: list[int | None], constants: dict[int, int], num_outputs: int):
